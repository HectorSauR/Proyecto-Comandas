...
namespace CrearTicketVenta
{
    ...
    public class CrearTicket
    {
        ...
        public void AgregaArticulo(string articulo, int cant, decimal precio, decimal importe)
        {
            ...
            if (cant.ToString().Length <= 15 && precio.ToString().Length <= 17 && importe.ToString().Length <= 15)
            {
                ...
                if (articulo.Length > 15)
                {
                    ...
                    nroEspacios = (11 - importe.ToString().Length);
                    espacios = "";
                    for (int i = 0; i < nroEspacios; i++)
                    {
                        espacios += " ";
                    ...
                    for (int longitudTexto = articulo.Length; longitudTexto > 15; longitudTexto -= 15)
                    {
                        ...
                        {
                            //agregamos los primeros 15 caracteres del nombre del articulos, mas lo que ya tiene la variable elemento
                ...
                {
                    for (int i = 0; i < (15 - articulo.Length); i++)
                    {
    ...
    {
        private static DateTime _fecha = DateTime.Now;
        ...
        public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
        {
            ...
            di.pDocName = Fecha.ToString();//Este es el nombre con el que guarda el archivo en caso de no imprimir a la impresora fisica.
